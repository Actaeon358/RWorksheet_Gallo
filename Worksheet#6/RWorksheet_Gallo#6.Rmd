...
names(scores) <- c("Student","Pre-test","Post-test")
...
```{r}
fLvl <- c(10,10,10, 20,20,50,10,20,10,50,20,50,20,10)

Olvl <- ordered(fLvl, levels = c(10,20,50))
...
```{r}
Elvl <- c("l", "n", "n", "i", "l", "l", "n", "n", "i", "l")


Fexercise <- factor(Elvl, levels = c("n", "l", "i"))
...
Fstate <- factor(state, levels = c("act", "nsw", "nt", "qld", "sa", "tas", "vic", "wa"))
...
Imeans <- tapply(incomes, factor_state, mean)
Imeans
